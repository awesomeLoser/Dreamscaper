...
for(var p = 0; p < page_number; p++)
	{
		...
		//find how many characters are on each page and store that in the "text_length" array
		text_length[p] = string_length(text[p]);
	
		//get the x position fopr the textbox dynamically
