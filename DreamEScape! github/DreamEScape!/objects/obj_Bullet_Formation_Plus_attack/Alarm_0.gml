...
var  bullet = instance_create_layer(pickX, obj_Player_Soul.bbox_top - 140, layer, bullet_Inst, {
	...
	image_yscale : 0.5,
=======
var pickX = random_range(obj_Player_Soul.bbox_left+ 0, obj_Player_Soul.bbox_right - 0 );

var  bullet = instance_create_layer(pickX, obj_Player_Soul.bbox_top - 240, layer, bullet_Inst, {
	gravity : 0.2,
	gravity_direction : 270,
...
var  bullet = instance_create_layer(obj_Player_Soul.bbox_right+ 200 , obj_Player_Soul.bbox_bottom - 20, layer, bullet_Inst, {
	...
	image_yscale : 0.5,
=======
var  bullet = instance_create_layer(obj_Player_Soul.bbox_right+ 400 , obj_Player_Soul.bbox_bottom - 40, layer, bullet_Inst, {
	gravity : 0.2,
	gravity_direction : 180,
...
var  bullet = instance_create_layer(obj_Player_Soul.bbox_left+ -200 , obj_Player_Soul.bbox_bottom - 20, layer, bullet_Inst, {
	...
	image_yscale : 0.5,
=======
var  bullet = instance_create_layer(obj_Player_Soul.bbox_left+ -400 , obj_Player_Soul.bbox_bottom - 40, layer, bullet_Inst, {
	gravity : 0.2,
	gravity_direction : 0,
