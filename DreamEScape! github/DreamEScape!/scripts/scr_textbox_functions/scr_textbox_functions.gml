function scr_set_deafults_for_text() 
{
...
line_break_offset[page_number] = 0; 
	...
	for (var c = 0; c < 500; c++)
		...
		shake_timer[c, page_number] = irandom(2);
		}

txtb_spr[page_number] = spr_textbox;
speaker_sprite[page_number] = noone;
speaker_side[page_number] = 1;
snd[page_number] = snd_voice_teto_mid;
}
		...
		switch(argument[1])	
			{
				//test npc
			case "test char":
				speaker_sprite[page_number] = spr_test_spk_neutral
				txtb_spr[page_number] = spr_textbox_blue
				snd[page_number] = snd_voice_teto_high;
				break;
				case "test char-happy":
				speaker_sprite[page_number] = spr_test_happy
				txtb_spr[page_number] = spr_textbox_blue
				snd[page_number] = snd_voice_teto_high;
				break;
				...
				//cactus
				case "tsundere":
				speaker_sprite[page_number] = spr_test_spk_npc
				txtb_spr[page_number] = spr_textbox_green
				snd[page_number] = snd_voice_teto_low;
				break;
